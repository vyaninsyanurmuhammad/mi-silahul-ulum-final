                ...
                <div className="flex flex-col w-full h-full p-7 gap-5 justify-end items-end">
                    <div className="flex flex-col space-y-8 w-fit justify-center items-center">
                        <div className="flex flex-row space-x-8">
                            <div className="h-[100px] w-[100px] lg:h-[200px] lg:w-[200px] bg-[url('/assets/img/hero-model-1.jpg')] bg-cover rounded-b-2xl rounded-t-[100px] overflow-hidden"></div>
                        ...
                        <div className="flex flex-row space-x-8">
                            <div className="h-[100px] w-[100px] lg:h-[200px] lg:w-[200px] bg-[url('/assets/img/hero-model-3.jpg')] bg-cover rounded-t-2xl rounded-b-2xl"></div>
                            <div className="h-[100px] w-[100px] lg:h-[200px] lg:w-[200px] bg-[url('/assets/img/hero-model-4.jpg')] bg-cover rounded-t-2xl rounded-b-[100px]"></div>
                        </div>
                    </div>
